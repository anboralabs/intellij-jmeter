 ...
 * This is a version of the original JLabelledRadio class (now removed), but
 * modified to accept resource names rather than language strings.
 *
 */
public class JLabeledRadioI18N
    extends JPanel implements JLabeledField, ActionListener {
   ...
   */
  public JLabeledRadioI18N(String labelResource, String[] itemResources,
                           String selectedItem) {
  ...
  public void resetButtons(String[] resources, String selected) {
    ...
    List<AbstractButton> buttonsToRemove =
        new ArrayList<>(this.bGroup.getButtonCount());
  ...
  /**
   * The implementation will get the resource name from the selected radio
   * button in the JButtonGroup.
   */
  @Override
