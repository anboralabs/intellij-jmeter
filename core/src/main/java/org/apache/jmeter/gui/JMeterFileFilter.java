...
public class JMeterFileFilter
    extends javax.swing.filechooser.FileFilter implements java.io.FileFilter {
   ...
   */
  public JMeterFileFilter(String[] extensions) { this(extensions, true); }
  ...
  public boolean accept(File f) {
    return (allowDirs && f.isDirectory()) ||
        accept(f.getName().toLowerCase(Locale.ROOT));
