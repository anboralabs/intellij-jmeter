...
public class PowerTableModel extends DefaultTableModel {
  private static final Logger log =
      LoggerFactory.getLogger(PowerTableModel.class);
  ...
  private static final List<Object> DEFAULT_ARGS = Collections.unmodifiableList(
      Arrays.asList("", 0, 0L, Boolean.FALSE, 0F, 0D, ' ', Byte.MIN_VALUE,
                    Short.MIN_VALUE));
  ...
  public Data getData() { return model; }
    ...
    try {
      ...
      for (Object initArg : DEFAULT_ARGS) {
        try {
          ...
          // no need to log this, as we are just trying out all available
          // default args
        }
      }
    }
