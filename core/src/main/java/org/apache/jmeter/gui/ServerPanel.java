...
public class ServerPanel extends JPanel {
  ...
  public String getServer() { return domain.getText(); }

  public void setServer(String value) { domain.setText(value); }

  public String getPort() { return port.getText(); }

  public void setPort(String value) { port.setText(value); }

  public String getConnectTimeout() { return connectTimeOut.getText(); }

  public void setConnectTimeout(String value) { connectTimeOut.setText(value); }

  public String getResponseTimeout() { return responseTimeOut.getText(); }
  ...
  private JPanel getPortPanel() {
    ...
    JLabel label =
        new JLabel(JMeterUtils.getResString("web_server_port")); // $NON-NLS-1$
