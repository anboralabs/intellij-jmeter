...
public class FilePanel extends FilePanelEntry {
  ...
  public FilePanel() { this("", (String)null); }

  public FilePanel(String title) { this(title, (String)null); }
  ...
  public FilePanel(String title, String filetype, boolean onlyDirectories) {
    super(JMeterUtils.getResString("file_visualizer_filename"), onlyDirectories,
          filetype); // $NON-NLS-1$
    this.title = title;
    init();
  }

  public FilePanel(ChangeListener l, String title) { this(l, title, false); }
