 ...
 * @deprecated {@link AbstractJMeterGuiComponent#createTitleLabel()} for better
...
public class CommentPanel extends JPanel {
  ...
  private void init() { // WARNING: called from ctor so must not be overridden
    ...
    JLabel commentLabel =
        new JLabel(JMeterUtils.getResString("testplan_comments")); //$NON-NLS-1$
  ...
  public String getText() { return this.commentField.getText(); }
