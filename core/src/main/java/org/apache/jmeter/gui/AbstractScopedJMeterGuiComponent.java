...
public abstract class AbstractScopedJMeterGuiComponent
   ...
   */
  protected JPanel createScopePanel() { return createScopePanel(false); }
   ...
   * Create the scope settings panel.
   * @param enableVariable set true to enable the variable panel
   * @param enableParentAndSubsamples set true to enable the parent and
   *     sub-samples
  ...
  protected JPanel createScopePanel(boolean enableVariable,
    ...
    scopePanel = new ScopePanel(enableVariable, enableParentAndSubsamples,
                                enableSubsamplesOnly);
    return scopePanel;
  }
