...
public final class TristateCheckBox extends JCheckBox {
  ...
  public TristateCheckBox() { this(null, null, TristateState.DESELECTED); }
  ...
  public TristateCheckBox(String text, boolean selected) {
    this(text, null,
         selected ? TristateState.SELECTED : TristateState.DESELECTED);
  }
  ...
  private static class TristateButtonModel extends ToggleButtonModel {
    ...
    private void displayState() {
      ...
      if (original) {
        ...
        if (state == TristateState.INDETERMINATE) {
          ...
          tristateCheckBox.setSelectedIcon(
              icon); // Nimbus works - after a fashion - with this
          tristateCheckBox.setDisabledSelectedIcon(
              icon); // Nimbus works - after a fashion - with this
        } else {     // reset
          if (tristateCheckBox != null) {
            ...
            tristateCheckBox.setDisabledSelectedIcon(
                null); // Nimbus works - after a fashion - with this
          }
        }
      }
    ...
    public TristateState getState() { return state; }
  }
