...
public class SimpleConfigGui
   ...
   */
  public SimpleConfigGui() { this(true); }
  ...
  public void modifyTestElement(TestElement el) {
    ...
    while (model.next()) {
      el.setProperty(
          new StringProperty((String)model.getColumnValue(COLUMN_NAMES_0),
  ...
  private Component createTablePanel() {
    tableModel =
        new PowerTableModel(new String[] {COLUMN_NAMES_0, COLUMN_NAMES_1},
