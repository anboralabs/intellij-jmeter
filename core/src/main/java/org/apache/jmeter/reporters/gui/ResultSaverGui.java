...
public class ResultSaverGui extends AbstractListenerGui
  ...
  public void configure(TestElement el) {
    ...
    numberPadLength.setText(
        resultSaver.getNumberPadLen() == 0
            ? ""
  ...
  private Component createSaveFormatPanel() {
    filename =
        new JLabeledTextField(JMeterUtils.getResString("resultsaver_prefix"));
    ...
    variableName =
        new JLabeledTextField(JMeterUtils.getResString("resultsaver_variable"));
    variableName.setName(ResultSaver.VARIABLE_NAME);

    JPanel panel = new JPanel(new GridBagLayout());
    panel.setBorder(BorderFactory.createTitledBorder(
        JMeterUtils.getResString("resultsaver_save_format"))); //$NON-NLS-1$
  ...
  private Component createSaveConditionsPanel() {
    ...
    ignoreTC = new JCheckBox(
        JMeterUtils.getResString("resultsaver_ignore_tc")); // $NON-NLS-1$

    JPanel panel = new JPanel(new GridBagLayout());
    panel.setBorder(BorderFactory.createTitledBorder(
        JMeterUtils.getResString("resultsaver_save_conditions"))); //$NON-NLS-1$
    GridBagConstraints gbc = new GridBagConstraints();
    initConstraints(gbc);
  ...
  private static void addField(JPanel panel, JCheckBox field,
  ...
  private static void addField(JPanel panel, JLabeledTextField field,
                               GridBagConstraints gbc) {
