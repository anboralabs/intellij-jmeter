...
/**
 * The class SyntheticResponseTimeDistributionGraphConsumer provides a graph to
 * visualize the distribution of the response times on APDEX threshold
 *
 * @since 3.1
 */
public class SyntheticResponseTimeDistributionGraphConsumer
  ...
  protected Map<String, GroupInfo> createGroupInfos() {
    return Collections.singletonMap(
        ...
        new GroupInfo(new SumAggregatorFactory(), new SyntheticSeriesSelector(),
  ...
  protected void initializeExtraResults(MapResultData parentResult) {
    ...
    String[] seriesLabels = new String[] {
        ...
        TOLERATED_LABEL.format(
            new Object[] {getSatisfiedThreshold(), getToleratedThreshold()}),
        UNTOLERATED_LABEL.format(new Object[] {getToleratedThreshold()}),
        FAILED_LABEL};
    String[] colors = new String[] {SATISFIED_COLOR, TOLERATED_COLOR,
                                    UNTOLERATED_COLOR, FAILED_COLOR};
   ...
   */
  public long getSatisfiedThreshold() { return satisfiedThreshold; }
   ...
   */
  public long getToleratedThreshold() { return toleratedThreshold; }
  ...
  private void formatLabels() {
    ...
    this.toleratedLabels = Collections.singletonList(TOLERATED_LABEL.format(
        new Object[] {this.satisfiedThreshold, this.toleratedThreshold}));
