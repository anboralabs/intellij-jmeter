...
public class StatisticsSummaryData {
  ...
  public long getElapsedTime() { return endTime - firstTime; }
   ...
   */
  public final long getFirstTime() { return firstTime; }
   ...
   * @return the errors
   */
  public final long getErrors() { return errors; }

  /**
   * @param errors
   *            the errors to set
   */
  public final void setErrors(long errors) { this.errors = errors; }

  /**
   * @return the total
   */
  public final long getTotal() { return total; }

  /**
   * @param total
   *            the total to set
   */
  public final void setTotal(long total) { this.total = total; }
   ...
   *            the min to set
   */
  public final void setMin(long min) { this.min = Math.min(this.min, min); }
   ...
   *            the max to set
   */
  public final void setMax(long max) { this.max = Math.max(this.max, max); }

  /**
   * @return the percentile1
   */
  public final PercentileAggregator getPercentile1() { return percentile1; }
   ...
   */
  public final PercentileAggregator getPercentile2() { return percentile2; }
   ...
   */
  public final PercentileAggregator getPercentile3() { return percentile3; }
   ...
   */
  public double getKBytesPerSecond() { return getBytesPerSecond() / 1024; }
   ...
   * @param value bytes
   */
  public void incBytes(long value) { bytes += value; }

  /**
   * Increment sent bytes
   * @param value bytes
   */
  public void incSentBytes(long value) { sentBytes += value; }
   ...
   */
  public MeanAggregator getMean() { return mean; }

  /**
   * @return the median response times
   */
  public PercentileAggregator getMedian() { return median; }
