...
/**
 * The class CodesPerSecondGraphConsumer provides a graph to visualize response
 * codes rate per second
 *
 * @since 3.0
 */
public class CodesPerSecondGraphConsumer extends AbstractOverTimeGraphConsumer {
  ...
  protected Map<String, GroupInfo> createGroupInfos() {
    return Collections.singletonMap(
        ...
        new GroupInfo(new TimeRateAggregatorFactory(), new CodeSeriesSelector(),
