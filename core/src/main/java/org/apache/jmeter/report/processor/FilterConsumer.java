...
public class FilterConsumer extends AbstractSampleConsumer {
   ...
   */
  public final boolean isReverseFilter() { return reverseFilter; }
   ...
   */
  public final SamplePredicate getSamplePredicate() { return samplePredicate; }
  ...
  public void consume(Sample sample, int channel) {
    ...
    if ((!reverseFilter && samplePredicate != null &&
         samplePredicate.matches(sample)) ||
        (reverseFilter &&
         (samplePredicate == null || !samplePredicate.matches(sample)))) {
