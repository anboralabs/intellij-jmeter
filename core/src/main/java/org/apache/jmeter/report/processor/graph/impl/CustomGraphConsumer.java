...
public class CustomGraphConsumer
    extends AbstractOverTimeGraphConsumer implements SampleConsumer {
  ...
  private static final Set<String> NATIVE_VARIABLES =
      new HashSet<>(Arrays.asList(
          CSVSaveService.DATA_TYPE, CSVSaveService.FAILURE_MESSAGE,
          CSVSaveService.LABEL, CSVSaveService.RESPONSE_CODE,
          CSVSaveService.RESPONSE_MESSAGE, CSVSaveService.SUCCESSFUL,
          CSVSaveService.THREAD_NAME, CSVSaveService.TIME_STAMP,
          CSVSaveService.CSV_ELAPSED, CSVSaveService.CSV_BYTES,
          CSVSaveService.CSV_SENT_BYTES, CSVSaveService.CSV_THREAD_COUNT1,
          CSVSaveService.CSV_THREAD_COUNT2, CSVSaveService.CSV_SAMPLE_COUNT,
          CSVSaveService.CSV_ERROR_COUNT, CSVSaveService.CSV_URL,
          CSVSaveService.CSV_FILENAME, CSVSaveService.CSV_LATENCY,
          CSVSaveService.CSV_CONNECT_TIME, CSVSaveService.CSV_ENCODING,
          CSVSaveService.CSV_HOSTNAME, CSVSaveService.CSV_IDLETIME));
   ...
   */
  public void setYAxis(String axis) { yAxis = axis; }
   ...
   */
  public void setXAxis(String axis) { xAxis = axis; }
   ...
   */
  public void setContentMessage(String message) { contentMessage = message; }
   ...
   */
  public String getSampleVariableName() { return sampleVariableName; }
  ...
  protected void initializeExtraResults(MapResultData parentResult) {
    parentResult.setResult(RESULT_CTX_GRANULARITY,
                           new ValueResultData(getGranularity()));
    ...
    parentResult.setResult(RESULT_SAMPLE_VARIABLE_NAME,
                           new ValueResultData(getSampleVariableName()));
    parentResult.setResult(RESULT_CONTENT_MESSAGE,
                           new ValueResultData(getContentMessage()));
  }
