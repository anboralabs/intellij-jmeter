...
public class Sample {
  ...
  private static final String CONTROLLER_PATTERN =
      "Number of samples in transaction";

  private static final String EMPTY_CONTROLLER_PATTERN =
      "Number of samples in transaction : 0";
   ...
   *         been built.
   */
  public long getSampleRow() { return row; }
   ...
   */
  public String getData(int index) { return data[index]; }
  ...
  public <T> T getData(Class<T> clazz, int index, String fieldName) {
    try {
      ...
      throw new SampleException(
          ERROR_ON_SAMPLE + (row + 1) + " converting field:" + fieldName +
              " at column:" + index + " to:" + clazz.getName() +
   ...
   */
  public String getName() { return getData(CSVSaveService.LABEL); }
   ...
   */
  public String getThreadName() { return getData(CSVSaveService.THREAD_NAME); }
