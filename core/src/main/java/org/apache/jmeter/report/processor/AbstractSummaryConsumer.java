...
public abstract class AbstractSummaryConsumer<TData>
  ...
  protected class SummaryInfo {
     ...
     */
    public final boolean isController() { return isController; }
     ...
     */
    public final TData getData() { return data; }
     ...
     */
    public final void setData(TData data) { this.data = data; }
   ...
   */
  public final boolean hasOverallResult() { return hasOverallResult; }
   ...
   */
  protected final SummaryInfo getOverallInfo() { return overallInfo; }
   ...
   */
  protected final Map<String, SummaryInfo> getSummaryInfos() { return infos; }
  ...
  private MapResultData createResultFromKey(String key) {
    ...
    if (data != null) {
      ...
      result.setResult(RESULT_VALUE_IS_CONTROLLER,
                       new ValueResultData(info.isController()));
