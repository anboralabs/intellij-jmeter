 ...
 * be saved: <ul> <li>mean = average</li> <li>standard deviation</li>
 *   <li>minimum</li>
 *   <li>maximum</li>
 * </ul>
 */
public class Calculator {
  ...
  public void addSample(SampleResult res) {
    ...
    // accumulateAndGet always performs the mutation, however, the "test start"
    // timestamp is stable, so we expect only a few operations to go through the
    // slow path of accumulateAndGet
   ...
   */
  public void addBytes(long newValue) { bytes.add(newValue); }

  /**
   * add Sent bytes
   * @param value sent bytes
   */
  private void addSentBytes(long value) { sentBytes.add(value); }

  public long getTotalBytes() { return bytes.sum(); }
  ...
  public int getCount() { return (int)getCountLong(); }

  public long getCountLong() { return count.sum(); }
   ...
   */
  public double getRate() { return getRatePerSecond(count.sum()); }
   ...
   */
  public double getBytesPerSecond() { return getRatePerSecond(bytes.sum()); }
