 ...
 * JSR223TestElement} scripting test elements. These also share the {@link
 * ScriptingBeanInfoSupport} class for configuration.
 */
public abstract class ScriptingTestElement extends AbstractTestElement {
  ...
  public final static String DEFAULT_SCRIPT_LANGUAGE =
      "groovy"; // if no language is chosen in GUI

  //-- For TestBean implementations only

  protected ScriptingTestElement() { super(); }
