 ...
 * are accepted to enable the SSL-connection.<p> <b>This is of course not
 * secure</b>
 */
public class TrustAllSSLSocketFactory
    extends SSLSocketFactory { // NOSONAR JMeter is a pentest and perf testing
                               // tool

  private final SSLSocketFactory factory;

  // Empty arrays are immutable
  private static final X509Certificate[] EMPTY_X509Certificate =
...
public Socket createSocket(InetAddress address, int port) throws IOException {
  return factory.createSocket(
      address, port); // NOSONAR JMeter is a pentest and perf testing tool
}
...
public Socket createSocket(String host, int port) throws IOException {
  return factory.createSocket(
      host, port); // NOSONAR JMeter is a pentest and perf testing tool
}
...
public Socket createSocket() throws IOException {
  return factory
      .createSocket(); // NOSONAR JMeter is a pentest and perf testing tool
}
