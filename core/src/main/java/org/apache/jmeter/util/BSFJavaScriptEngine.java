...
public class BSFJavaScriptEngine extends BSFEngineImpl {
  ...
  public Object call(Object object, String method, Object[] args)
    ...
    } catch (Throwable t) { // NOSONAR We handle correctly Error case in
                            // function
      handleError(t);
    } finally {
      Context.exit();
  ...
  public void declareBean(BSFDeclaredBean bean) throws BSFException {
    if ((bean.bean instanceof Number) || (bean.bean == null) ||
  ...
  public Object eval(String source, int lineNo, int columnNo, Object oscript)
    ...
    try {
      ...
      if (retval instanceof NativeJavaObject) {
        ...
        Throwable t) { // NOSONAR We handle correctly Error case in function,
  ...
  private static void handleError(Throwable t) throws BSFException {
    ...
    } else if (target instanceof EvaluatorException || target instanceof
                                                           SecurityException) {
      message = target.getLocalizedMessage();
  ...
  @Override
  public void
  initialize(BSFManager mgr, String lang,
