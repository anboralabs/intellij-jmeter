...
public abstract class BSFTestElement
    extends ScriptingTestElement implements Serializable {
  private static final long serialVersionUID = 235L;

  private static final Logger log =
      LoggerFactory.getLogger(BSFTestElement.class);

  static {
    log.info(
        "Registering JMeter version of JavaScript engine as work-round for BSF-22");
  ...
  protected BSFTestElement() { super(); }
  ...
  protected void initManager(BSFManager mgr) throws BSFException {
    ...
    mgr.declareBean("Parameters", scriptParameters,
