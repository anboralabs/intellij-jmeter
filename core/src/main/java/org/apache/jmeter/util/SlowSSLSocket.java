 ...
 *
 * WARNING: the class relies on overriding all superclass methods in order to
 * apply them to the input socket. Any missing methods will access the
 * superclass socket, which will probably be in the wrong state.
 *
 */
