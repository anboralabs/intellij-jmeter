...
public abstract class ScriptingBeanInfoSupport extends BeanInfoSupport {
  ...
  protected ScriptingBeanInfoSupport(Class<? extends TestBean> beanClass,
                                     String[] languageTags, ResourceBundle rb) {
    super(beanClass);
     ...
     * org.apache.jmeter.util.JSR223TestElement#cacheKey does not appear to have
     * been configured
     *
  ...
  public static class JSR223ScriptCacheCheckboxEditor
      extends PropertyEditorSupport implements ActionListener, ClearGui {
