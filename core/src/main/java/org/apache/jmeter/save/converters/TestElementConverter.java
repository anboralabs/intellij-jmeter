...
public class TestElementConverter extends AbstractCollectionConverter {
  private static final Logger log =
      LoggerFactory.getLogger(TestElementConverter.class);
  ...
  public void marshal(Object arg0, HierarchicalStreamWriter writer,
    ...
    while (iter.hasNext()) {
      ...
      if (!ConversionHelp.isSpecialProperty(jmp.getName())) {
        // Don't save empty comments - except for the TestPlan (to maintain
        // compatibility)
  ...
  public Object unmarshal(HierarchicalStreamReader reader,
    ...
    if (guiClass == null) {
      throw new IllegalArgumentException(ConversionHelp.ATT_TE_GUICLASS +
    ...
    context.put(SaveService.TEST_CLASS_NAME,
                targetName); // needed by property converters  (Bug 52466)
    try {
      ...
      // Slight hack - we need to ensure the TestClass is not reset by the
      // previous call
   ...
   */
  public TestElementConverter(Mapper arg0) { super(arg0); }
}
