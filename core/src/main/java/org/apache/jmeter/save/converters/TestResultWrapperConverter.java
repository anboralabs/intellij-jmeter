...
public class TestResultWrapperConverter extends AbstractCollectionConverter {
   ...
   */
  public TestResultWrapperConverter(Mapper arg0) { super(arg0); }
   ...
   * If the ResultCollector helper object is defined, then pass the samples to
   * that rather than adding them to the test result wrapper.
   *
  ...
  public Object unmarshal(HierarchicalStreamReader reader,
    ...
    final ResultCollectorHelper resultCollectorHelper =
        (ResultCollectorHelper)context.get(
            SaveService.RESULTCOLLECTOR_HELPER_OBJECT);
    while (reader.hasMoreChildren()) {
      reader.moveDown();
      SampleResult sample =
          (SampleResult)readBareItem(reader, context, results);
