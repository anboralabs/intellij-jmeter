...
public class TestElementPropertyConverter extends AbstractCollectionConverter {
  private static final Logger log =
      LoggerFactory.getLogger(TestElementPropertyConverter.class);
  ...
  public Object unmarshal(HierarchicalStreamReader reader,
    ...
    try {
      TestElementProperty prop =
          (TestElementProperty)createCollection(context.getRequiredType());
      prop.setName(
      ...
      prop.setObjectValue(aClass.asSubclass(TestElement.class)
                              .getDeclaredConstructor()
                              .newInstance()); // Always decode
      TestElement te = (TestElement)prop.getObjectValue();
      ...
      return new TestElementProperty("ERROR",
                                     new ConfigTestElement()); // $NON-NLS-1$
    }
  }
   ...
   */
  public TestElementPropertyConverter(Mapper arg0) { super(arg0); }
}
