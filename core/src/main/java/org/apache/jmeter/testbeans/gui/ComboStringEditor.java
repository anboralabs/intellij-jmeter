...
class ComboStringEditor
    extends PropertyEditorSupport implements ItemListener, ClearGui {
  ...
  ComboStringEditor(String[] pTags, boolean noEdit, boolean noUndefined,
                    ResourceBundle rb) {
   ...
   */
  public void setInitialEditValue(String object) { initialEditValue = object; }
