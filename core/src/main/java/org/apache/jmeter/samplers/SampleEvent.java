...
public class SampleEvent implements Serializable {
  ...
  private final String threadGroup; // TODO appears to duplicate the threadName
   ...
   */
  public SampleEvent() { this(null, null); }
  ...
  private SampleEvent(SampleResult result, String threadGroup, String hostname,
   ...
   */
  public static int getVarCount() { return variableNames.length; }
   ...
   */
  public static String getVarName(int i) { return variableNames[i]; }
   ...
   */
  public boolean isTransactionSampleEvent() { return isTransactionSampleEvent; }
