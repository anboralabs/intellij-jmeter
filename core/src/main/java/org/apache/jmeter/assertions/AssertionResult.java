...
public class AssertionResult implements Serializable, Searchable {
   ...
   */
  @Deprecated public AssertionResult() { // Needs to be public for tests
    this.name = null;
  }
   ...
   */
  public AssertionResult(String name) { this.name = name; }
  ...
  /**
   * Set the flag indicating whether or not an error occurred while evaluating
