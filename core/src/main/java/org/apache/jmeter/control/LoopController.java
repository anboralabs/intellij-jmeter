...
public class LoopController extends GenericController
  ...
  private static final Logger LOGGER =
      LoggerFactory.getLogger(LoopController.class);
  ...
  @Override
  public PropertiesAccessor<? extends LoopController, ?
                                extends LoopControllerSchema>
  getProps() {
    return new PropertiesAccessor<>(this, getSchema());
  }

  public void setLoops(int loops) { set(getSchema().getLoops(), loops); }
  ...
  public int getLoops() {
    ...
    if (nbLoops == null || // No evaluated yet
        nbLoops == 0 ||    // Last iteration led to nbLoops == 0,
                           ...
                           // it leads to no further evaluations if we don't
                           // evaluate, see BUG 56276
  ...
  public String getLoopString() { return getString(getSchema().getLoops()); }
  ...
  protected void incrementLoopCount() { loopCount++; }
  ...
  public void iterationStart(LoopIterationEvent iterEvent) {
    if (LOGGER.isDebugEnabled()) {
      LOGGER.debug(
          "iterationStart called on {} with source {} and iteration {}",
          getName(), iterEvent.getSource(), iterEvent.getIteration());
    }
    reInitialize();
    resetLoopCount();
  }
