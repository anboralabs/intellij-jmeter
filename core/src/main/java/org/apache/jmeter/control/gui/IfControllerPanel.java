...
public class IfControllerPanel
    extends AbstractControllerGui implements ChangeListener, ActionListener {
   ...
   */
  public IfControllerPanel() { this(true); }
  ...
  private JPanel createConditionPanel() {
    ...
    warningLabel = new JLabel(JMeterUtils.getResString("if_controller_warning"),
                              image, SwingConstants.LEFT); // $NON-NLS-1$
    ...
    JLabel ifControllerTipLabel = new JLabel(
        JMeterUtils.getResString("if_controller_tip")); // $NON-NLS-1$
    useLastSampleStatusButton = new JButton(JMeterUtils.getResString(
        "if_controller_use_last_sample_ok")); // $NON-NLS-1$
  ...
  public void stateChanged(ChangeEvent e) {
    if (e.getSource() == useExpression) {
      ...
      if (useExpression.isSelected()) {
        ...
        conditionLabel.setText(JMeterUtils.getResString(
            "if_controller_expression_label")); // $NON-NLS-1$
  ...
  public void actionPerformed(ActionEvent e) {
    ...
    if (action.equals(USE_LAST_SAMPLE_OK)) {
      theCondition.setText(theCondition.getText() +
