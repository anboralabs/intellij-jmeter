 ...
 * (not exposed as a GUI class, as it is only used internally by
 * TransactionController in Generate Parent sample mode)
 */
public class TransactionSampler extends AbstractSampler {
  ...
  public Sampler getSubSampler() { return subSampler; }

  public SampleResult getTransactionResult() { return transactionSampleResult; }

  public TransactionController getTransactionController() {
    return transactionController;
  }

  public boolean isTransactionDone() { return transactionDone; }
  ...
  protected void setTransactionDone() {
    ...
    transactionSampleResult.setResponseMessage(
        TransactionController.NUMBER_OF_SAMPLES_IN_TRANSACTION_PREFIX + calls +
    ...
    if (!transactionController.isIncludeTimers()) {
      ...
      transactionSampleResult.setIdleTime(
          end - transactionSampleResult.getStartTime() - totalTime);
