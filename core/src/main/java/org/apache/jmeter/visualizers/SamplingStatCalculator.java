...
public class SamplingStatCalculator {
   ...
   */
  public synchronized void clear() { init(); }

  public Sample getCurrentSample() { return currentSample; }
  ...
  public Sample addSample(SampleResult res) {
    ...
    synchronized (calculator) {
      ...
      throughput =
          ((double)calculator.getCount() / (double)howLongRunning) * 1000.0;
  ...
  public double getErrorPercentage() {
    ...
    rval = (double)getCurrentSample().getErrorCount() /
           (double)calculator.getCount();
    return rval;
  }
  ...
  /** @return errorCount */
  public long getErrorCount() { return getCurrentSample().getErrorCount(); }
  ...
  public long getCount() { return calculator.getCount(); }

  public Number getMax() { return calculator.getMax(); }

  public double getMean() { return calculator.getMean(); }

  public Number getMeanAsNumber() { return (long)calculator.getMean(); }

  public Number getMedian() { return calculator.getMedian(); }
