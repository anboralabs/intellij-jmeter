...
public class Sample implements Serializable, Comparable<Sample> {
  ...
  public Sample(String name, long data, long average, long deviation,
                long median, long distributionLine, double throughput,
                long errorCount, boolean success, long num, long endTime) {
    this.data = data;
  ...
  public Sample() { this(null, 0, 0, 0, 0, 0, 0, 0, true, 0, 0); }
   ...
   */
  public long getDeviation() { return deviation; }

  /**
   * @return Returns the distributionLine.
   */
  public long getDistributionLine() { return distributionLine; }
  ...
  /**
   * @return Returns the (calculated) startTime, assuming Data is the elapsed
   *     time.
   */
  public long getStartTime() { return endTime - data; }
