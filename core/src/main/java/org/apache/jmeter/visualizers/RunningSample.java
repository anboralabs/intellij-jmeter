 ...
 * index were not final. Also the caller needs to synchronize access in order to
 * ensure that variables are consistent.
 * </p>
 *
 */
public class RunningSample {
  ...
  private final DecimalFormat errorFormatter =
   ...
   *         the RunningSample class.
   */
  public long getNumSamples() { return counter; }
