...
import co.anbora.labs.jmeter.ide.utils.addTextChangeListener
import co.anbora.labs.jmeter.ide.utils.pathAsPath
...
class JMeterToolchainPathChoosingComboBox(onTextChanged: () -> Unit = {}) :
