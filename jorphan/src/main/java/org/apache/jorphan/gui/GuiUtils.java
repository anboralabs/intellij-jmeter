...
public final class GuiUtils {
  ...
  public static String getPastedText()
    ...
    if (Collections.addAll(flavours, flavourList) &&
        flavours.contains(DataFlavor.stringFlavor)) {
  ...
  public static void makeScrollableMenu(JMenu menu) {
    if (menu.getItemCount() > 0 && !GraphicsEnvironment.isHeadless()) {
      ...
      int maxItems = (int)Math.round(
          screenSize.getHeight() * 0.8 /
          menu.getMenuComponent(0).getPreferredSize().getHeight());
