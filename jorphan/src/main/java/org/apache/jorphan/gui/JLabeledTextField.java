...
public class JLabeledTextField
    extends JPanel implements JLabeledField, FocusListener {
   ...
   */
  public JLabeledTextField() { this("", 20, null, true); }
   ...
   */
  public JLabeledTextField(String pLabel) { this(pLabel, 20, null, true); }
   ...
   */
  public JLabeledTextField(String pLabel, int size, Color bk,
                           boolean editable) {
    super();
