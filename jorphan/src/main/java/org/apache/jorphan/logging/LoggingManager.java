...
public final class LoggingManager {
  ...
  public static final String DEFAULT_PATTERN =
      "%{time:yyyy/MM/dd HH:mm:ss} %5.5{priority} - " //$NON_NLS-1$
      + "%{category}: %{message} %{throwable}";       //$NON_NLS-1$

  /**
   * @deprecated  since 3.2, use SLF4J for logging
   */
  @Deprecated public static final String LOG_FILE = "log_file"; //$NON_NLS-1$
   ...
   * Get the Logger for a class.
   *
   * @param category - the full name of the logger category, this will have the
   *     prefix removed.
   *
   * @return Logger
   * @deprecated since 3.2, use SLF4J for logging
   ...
   *
   * @param priority - string containing the priority name, e.g. "INFO", "WARN",
   *     "DEBUG", "FATAL_ERROR"
