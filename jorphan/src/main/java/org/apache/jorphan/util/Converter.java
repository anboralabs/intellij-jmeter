...
public class Converter {
  ...
  private static Optional<Date> tryToParseDate(Object date) {
    return Stream
        .of(DateFormat.SHORT, DateFormat.MEDIUM, DateFormat.LONG,
            DateFormat.FULL)
  ...
  private static Optional<Date> tryToParseDate(DateFormat formatter,
                                               String dateString) {
    try {
   ...
   *         failed
   */
  public static float getFloat(Object o) { return getFloat(o, 0); }
   ...
   *         failed
   */
  public static double getDouble(Object o) { return getDouble(o, 0); }
   ...
   *         failed
   */
  public static boolean getBoolean(Object o) { return getBoolean(o, false); }
  ...
  /**
   * Convert object to integer, return <code>defaultValue</code> if object is
   ...
   */
  public static char getChar(Object o) { return getChar(o, ' '); }
   ...
   */
  public static int getInt(Object o) { return getInt(o, 0); }
   ...
   */
  public static long getLong(Object o) { return getLong(o, 0); }
   ...
   */
  public static String getString(Object o) { return getString(o, ""); }
  ...
  public static File getFile(Object o) {
    ...
    throw new IllegalArgumentException("Expected String or file, actual " +
                                       o.getClass().getName());
  }
}
