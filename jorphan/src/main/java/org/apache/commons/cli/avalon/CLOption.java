...
public final class CLOption {
  /**
   * Value of {@link CLOptionDescriptor#getId} when the option is a text
   * argument.
   */
  ...
  private static final CLOptionDescriptor TEXT_ARGUMENT_DESCRIPTOR =
      new CLOptionDescriptor(null, CLOptionDescriptor.ARGUMENT_OPTIONAL,
                             TEXT_ARGUMENT, null);
   ...
   */
  public final String getArgument() { return getArgument(0); }
  ...
  public final CLOptionDescriptor getDescriptor() { return this.descriptor; }
