...
public final class Priority implements Serializable {
  ...
  /**
   * Useful information messages such as state changes, client connection, user
   * login etc.
   */
   ...
   */
  public int getValue() { return m_priority; }
   ...
   */
  private Object readResolve() { return getPriorityForName(m_name); }
}
