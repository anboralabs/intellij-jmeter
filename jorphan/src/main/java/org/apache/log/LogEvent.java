...
public final class LogEvent implements Serializable {
   ...
   */
  public final ContextMap getContextMap() { return m_contextMap; }
   ...
   */
  public final String getCategory() { return m_category; }
   ...
   * @return the message
   */
  public final String getMessage() { return m_message; }
   ...
   */
  public final Throwable getThrowable() { return m_throwable; }
   ...
   * @return the time
   */
  public final long getRelativeTime() { return m_time - START_TIME; }
   ...
   */
  public final void setMessage(final String message) { m_message = message; }
   ...
   * @param time the time
   */
  public final void setTime(final long time) { m_time = time; }
